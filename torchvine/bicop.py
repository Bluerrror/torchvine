...
from .optimize import coordinate_descent_maximize, golden_section_maximize
...
class Bicop:
    ...
    def plot(self, *args, **kwargs):
        ...
        z = self.pdf(grid).reshape(n, n).detach().cpu().numpy()
    ...
    def fit(self, data: torch.Tensor, controls: FitControlsBicop | None = None) -> "Bicop":
        ...
        # MLE / pseudo-MLE via derivative-free optimization.
